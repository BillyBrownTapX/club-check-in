...
import { z } from "zod";
import { AuthCard, AuthShell, AuthSupportLinks, EmailInput, InlineErrorMessage, PageHeadingBlock, PrimaryButton, SecondaryTextLink, SuccessBanner } from "@/components/attendance-hq/host-onboarding";
  ...
  return (
    <AuthShell>
      <AuthCard>
        ...
        {success ? <SuccessBanner message="Reset link sent. Check your email to continue." /> : null}
